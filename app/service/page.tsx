...
import { SidebarContent } from "../components/ServiceSidebar";
            ...
            case "usage":
                return (
                    <div className="mx-auto max-w-4xl">
                        ...
                        <p className="text-muted-foreground">Your usage statistics will appear here.</p>
                    </div>
                );
            case "billing":
                return (
                    <div className="mx-auto max-w-4xl">
                        ...
                        <p className="text-muted-foreground">Manage your billing and payment methods here.</p>
                    </div>
                );
            default:
                return <ServicesList />;
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <header className="flex h-16 items-center border-b px-4 md:hidden bg-sidebar text-sidebar-foreground">
                    <Sheet>
                        ...
                        <SheetContent side="left" className="w-[300px] p-0 bg-sidebar border-r-sidebar-border text-sidebar-foreground [&>button]:hidden">
                            <SheetTitle className="sr-only">Navigation Menu</SheetTitle>
                            <SidebarContent isSheet currentView={currentView} setCurrentView={setCurrentView} />
                        </SheetContent>
                    </Sheet>
